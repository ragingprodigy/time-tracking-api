...
export 'package:time_tracker/time_tracker.dart';
export 'package:aqueduct/test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for time_tracker.
///
/// Use instances of this class to start/stop the test time_tracker server. Use [client] to execute
...
class TestApplication {
  ...
  Application<TimeTrackerSink> application;
  TimeTrackerSink get sink => application.mainIsolateSink;
  TestClient client;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [TimeTrackerSink].
  /// The declared [ManagedObject]s in this application will be
  /// used to generate a temporary database schema. The [TimeTrackerSink] instance will use
  ...
  Future start() async {
    ...
    application = new Application<TimeTrackerSink>();

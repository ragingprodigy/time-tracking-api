...
Routes and other initialization are configured in `lib/time_tracker_sink.dart`. Endpoint controllers file are in `lib/controller/`.
...
aqueduct auth add-client \
    --id com.time_tracker.mobile
    --secret myspecialsecret
    --connect postgres://user:password@host:5432/time_tracker
```

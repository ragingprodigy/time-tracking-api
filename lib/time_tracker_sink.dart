...
/// for more details.
class TimeTrackerSink extends RequestSink {
  ...
  TimeTrackerSink(ApplicationConfiguration appConfig) : super(appConfig) {
    logger.onRecord.listen((rec) => print("$rec ${rec.error ?? ""} ${rec.stackTrace ?? ""}"));

    var options = new TimeTrackerConfiguration(appConfig.configurationFilePath);
...
class TimeTrackerConfiguration extends ConfigurationItem {
  TimeTrackerConfiguration(String fileName) : super.fromFile(fileName);
